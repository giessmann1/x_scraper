            ...
            for tweet in timeline:
                try:
                    ...
                    if tweet_data == -1:
                        ...
                        return None if len(new_tweet_ids) == 0 else new_tweet_ids  # Stop scraping
                    elif tweet_data:
                        if is_profile == False:
                        ...
                        if is_profile:
                            ...
                            new_tweet_ids.append(f"https://xcancel.com/{tweet_data['username_str']}/status/{tweet_data[ID_NAME]}")
